...
class ProductControllerTest {
    ...
    fun setup(){
        ...
        every { productRepository.save(productOneActive) } returns productOneActive
    ...
    fun `update status product active to inactive`(){
        ...
        every { productRepository.findById(productOneActive.id) } returns Optional.of(productOneActive)
